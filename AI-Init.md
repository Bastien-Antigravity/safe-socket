...
> 
> "1. Read the ecosystem map in [Ecosystem-Map-MOC.md](Ecosystem-Map-MOC.md)."
> "2. Load project constraints from [AI-Project-DNA.md](AI-Project-DNA.md)."
> "3. Restore session state from [AI-Session-State.md](AI-Session-State.md)."
