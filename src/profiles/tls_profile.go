...
func (p *TlsHelloClientProfile) GetTransport() interfaces.TransportType {
	return interfaces.TransportTLS
}
func (p *TlsHelloClientProfile) GetProtocol() interfaces.ProtocolType {
	return interfaces.ProtocolHello
}
...
func (p *TlsHelloServerProfile) GetTransport() interfaces.TransportType {
	return interfaces.TransportTLS
}
func (p *TlsHelloServerProfile) GetProtocol() interfaces.ProtocolType {
	return interfaces.ProtocolHello
}
